...
import {  getDelegatorInfo , getLastPost, getVoterAccount } from "../utils/helper";
...
export async function votePost(author , permLink , timestamp){
  ...
  const vote_time = new Date(new Date(timestamp).getTime() + 238 * 1000);
  // console.log(
 ...
 client.broadcast.vote(
  ...
  //  schedule.scheduleJob(vote_time), async () => {
  //   try{
